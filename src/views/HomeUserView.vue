  ...
  <div class="bg-light">
    ...
    <div id="userCarousel" class="carousel slide">
      <div class="carousel-indicators">
        <button v-for="(_, i) in slides" :key="i" type="button" data-bs-target="#userCarousel" :data-bs-slide-to="i" :class="{ active: i === 0 }"></button>
      </div>
      ...
      <button class="carousel-control-prev" type="button" data-bs-target="#userCarousel" data-bs-slide="prev"><span class="carousel-control-prev-icon"></span></button>
      <button class="carousel-control-next" type="button" data-bs-target="#userCarousel" data-bs-slide="next"><span class="carousel-control-next-icon"></span></button>
    </div>
    ...
    <div class="container mt-4 mb-5">
      <div v-if="loading" class="text-center py-5 w-100">
        ...
        <p class="mt-2 text-muted" style="font-size:14px;">Memuat koleksi terbaru...</p>
      </div>
...
const slides = [
  ...
  { title: 'Gaya Kasual Pria', subtitle: 'Tampil trendi dan nyaman setiap hari.' },
  { title: 'Diskon Spesial', subtitle: 'Dapatkan potongan harga hingga 50% untuk produk pilihan.' },
]
